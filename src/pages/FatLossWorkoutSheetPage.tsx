...
const tagClasses: Record<FatLossExerciseTag, string> = {
  ...
  Cardio: 'bg-[#efefef] text-[#111111] border-[#d4d4d8]',
}

export default function FatLossWorkoutSheetPage() {
  ...
  const tagLabels: Record<FatLossExerciseTag, string> = {
    ...
    Cardio: isRussian ? 'Кардио' : 'Cardio',
  }
